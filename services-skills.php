						...
						<div class="block-item">
							<div class="row">
								...
								<div class="col-xlarge-9">
									...
									<p>Web design is normally used to describe the design process relating to the front-end (client side) design of a website. Web design partially overlaps web engineering.</p>
								</div>
							</div>
						</div>
					</li>
					...
					<li class="col-xlarge-6 col-medium-6">
						<div class="block-item">
							<div class="row">
								...
								<div class="col-xlarge-9">
									<h3 class="font-montserrat-reg">Software Development</h3>
									<p>With skills comes great responsibility. We take Software Development to the maximum. We follow strict standards to give a highly reliable software of your need.</p>
								</div>
							</div>
						</div>
					</li>
					...
					<li class="col-xlarge-6 col-medium-6">
						<div class="block-item">
							<div class="row">
								...
								<div class="col-xlarge-9">
									<h3 class="font-montserrat-reg">Advertisement Specialist</h3>
									<p>Marketing and communication design on a website may identify what works for its target market. Thus the designer may understand the trends of its audience. </p>
								</div>
							</div>
						</div>
					</li>
					...
					<li class="col-xlarge-6 col-medium-6">
						<div class="block-item">
							<div class="row">
								...
								<div class="col-xlarge-9">
									<h3 class="font-montserrat-reg">Database</h3>
									<p>The backside is as important as the interface. We make sure that every data, no matter how small, is kept secured and safe. Following world-class practices.</p>
								</div>
							</div>
						</div>
					</li>
